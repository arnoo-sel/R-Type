...
float       Boss::getFireRate() const
{
    return (2);
}

char        Boss::getType() const
{
	return (3);
}

Vertex<int> Boss::move(float time) const
{
    static int mode = 3;
    static int rage = 0;
...
Vertex<int> Boss::fire(float time) const
{
    return (Vertex<int>(-100, 0));
}

Vertex<int> Boss::canon(float time) const
{
    Vertex<int> canons[3];
...
Vertex<int> Boss::spawnPos(float time) const
{
